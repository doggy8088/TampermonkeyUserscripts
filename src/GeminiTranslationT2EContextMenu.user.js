...
// @source       https://github.com/doggy8088/TampermonkeyUserscripts/raw/main/src/GeminiTranslationT2EContextMenu.user.js
// @namespace    https://github.com/doggy8088/TampermonkeyUserscripts/raw/main/src/GeminiTranslationT2EContextMenu.user.js
// @match        *://*/*
// @author       Will Huang
// @run-at       context-menu
// @grant        GM_openInTab
...
(() => {
  ...
  if (!!html) {
    ...
    let prompt = "Please translate the following text into English. No explanations and additional information of the translations are required. Ensure the translations' completeness. Here is the text:\n```\n{input}\n```";

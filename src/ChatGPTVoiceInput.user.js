...
(async function () {
    ...
    microphoneButtonElement.title = '切換語音辨識功能 (alt+s, command+option+s)';
    ...
    speakerButtonElement.title = '切換語音合成功能 (alt+m, command+option+m)';
    ...
    class VoiceInputHelper {
        ...
        Start() {
            ...
            this.microphoneButton.title = '關閉語音辨識功能 (alt+s)';
        }
        ...
        Stop() {
            ...
            this.microphoneButton.title = '開啟語音辨識功能 (alt+s)';
        }
